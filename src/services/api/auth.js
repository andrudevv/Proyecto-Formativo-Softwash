...
export const updateUser = (userUpdate) =>
  Axios.patch(`${API}/users/`, userUpdate);
...
export const registerAppointment = (appointment) =>
  Axios.post(`${API}/appointment/create-appointment`, appointment);

// ruta para obtener disponibilidad segun el id del servicio y fecha
export const availabilityFound = (idService, date) =>
  Axios.get(`${API}/appointment/${idService}/${date}`);

//ruta para obtener servicios del lavadero seleccionado
export const getProfileWithServices = (id, query) =>
  Axios.get(`${API}/users/view-profile/${id}`, { params: query });
...
export const changuePhotoClient = (img) =>
  Axios.patch(`${API}/client/img-profile`, img, {
    headers: {
...
export const sendFinalizedAppointment = (id) =>
  Axios.patch(`${API}/appointment/update-appointment-finalized/${id}`);
...
export const appointmentDeleted = (idAppointment) =>
  Axios.delete(`${API}/appointment/delete-appointment/${idAppointment}`);
//ruta para traer los servicios del lavadero
export const getServicesLaudry = (query) =>
  Axios.get(`${API}/service`, { params: query });
// ruta para actualizar servicio
export const updateService = (id, dataUpdate) =>
  Axios.patch(`${API}/service/${id}`, dataUpdate);
// ruta para crear servicio
export const createService = (newService) =>
  Axios.post(`${API}/service/create-service`, newService);
...
export const updateClient = (dataClient) =>
  Axios.patch(`${API}/client`, dataClient);
...
export const availabilityFoundClient = (id, date) =>
  Axios.get(`${API}/appointment/reschedule/${id}/${date}`);

// ruta para traer la cita a reagendar
export const findAppointmentForReschedule = (id) =>
  Axios.get(`${API}/appointment/get-appointment-reschedule/${id}`);

//ruta para filtro de citas segun fecha y estado
export const FindAppointments = (date, state) =>
  Axios.get(`${API}/appointment/get-appointments/${date}`, { params: state });

//ruta para filtrar las citas no asistidas, por fecha o placa
export const FindAppointmentsAbsence = (query) =>
  Axios.get(`${API}/appointment/get-appointments-absence/`, { params: query });

//ruta para actualizar la cita confirmando asistencia
export const sendToProcess = (id, state) =>
  Axios.patch(`${API}/appointment/my-appointments/${id}`, state);

//ruta para el filtro de los lavaderos del lado del usuario
export const FindLaundry = (queryFind) =>
  Axios.get(`${API}/client/`, { params: queryFind });

//ruta para traer las citas que el cliente envia a proceso
export const getProcessAppointments = () =>
  Axios.get(`${API}/appointment/get-process-appointment`);
//ruta para actualizar o reagendar la cita
export const updateAndReschedule = (idAppointment, appointment) =>
  Axios.patch(
    `${API}/appointment/update-appointment/${idAppointment}`,
    appointment
  );
