    ...
    <>
      ...
      <div className="flex items-center justify-center h-screen ">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-button-primary  text-black hover:scale-110 font-semibold mt-4 py-2 px-4 rounded transition delay-150 duration-300 ease-in-out hover:bg-blue-400  w-full"
          >
            iniciar sesion
          </button>
          <button className="bg-button-primary text-black font-semibold hover:scale-110 mt-4 py-2 px-4 rounded transition delay-150 duration-300 ease-in-out hover:bg-blue-400  w-full">
            <Link to="/sign-in-user">iniciar sesion como usuario</Link>
          </button>
          <a className=" text-cyan-800 font-semibold text-lg mt-4 py-2 px-4 rounded hover:scale110 w-full">
            <Link to="/reset-password-client">Olvido su contraseña?</Link>
          </a>
