...
export default function () {
  ...
  const customButtons = [
    {
      ...
      estilos:
        "bg-green-500 hover:bg-green-700 min-w-[70%] text-white font-bold h-auto py-1  px-2 rounded ",
    },
    {
      text: "eliminar",
      tipo: "button",
  ...
  return (
    <>
      ...
      />
      <div className="flex justify-center text-2xl font-bold mt-8 mb-6">
        <h2>Citas perdidas pendientes por reagendar</h2>
      </div>
      <h2 className="w-full justify-center text-center font-bold">
        Buscar por:
      </h2>
      <div className="w-full h-12 bg-blue-200 flex justify-around">
        ...
        <button
          className="bg-yellow-400 flex items-center rounded-lg w-24 justify-center my-1"
          onClick={findAppointmentsAbsence}
        >
          Buscar
        </button>
      </div>
