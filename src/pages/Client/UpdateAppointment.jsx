  ...
  const handleDateChange = async (date) => {
    ...
    if (formattedDate) {
      try {
        ...
        const availabilityFound = await getAvailability(
          idService,
          formattedDate
        );
        ...
        const generateAvailbility = await generateHour(
          apertureLaundry,
          closingLaundry,
          hours,
          laundryAvailability
        ...
        <>
          <div>
            <section className=" w-full  py-12 ">
              <form
                onSubmit={onSubmitAppointmentReschedule}
                className="w-full  mx-auto border-2 px-2 py-4 shadow-lg shadow-blue-500 rounded-md bg-gray-100"
              >
                <div className="flex">
                  <div className="w-1/2 mx-20 py-4 px-8 ">
                    <div className="relative  w-full mb-5 group">
                      <label className=" mr-4 text-black font-semibold ">
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <label
                        className="block  text-gray-900  border-b-2 border-gray-400 break-all "
                        placeholder="Tener cuidado con ..."
                      >
                        {dateAppointment.observations}
                      </label>
                    </div>
                    <div className="relative z-0 w-full mb-5 group">
                      ...
                      <label className="block  text-gray-900  border-b-2 border-gray-400  break-all  ">
                        {dateService.name}
                      </label>
                    </div>
                    <div className="relative z-0 w-full mb-5 group">
                      <span className="text-gray-600 font-semibold">Total</span>
                      <label className="block  text-gray-900  border-b-2 border-gray-400   ">
                        {dateService.price}
                      </label>
                    </div>
                  </div>
                  <div className="w-1/2 flex max-h-full p-4 ">
                    <div className="relative z-0 w-full h-full text-center mb-5 group">
                      <label className="  text-black font-semibold mt-2 text-center">
                      ...
                      <section className="grid grid-cols-2 border-2 border-gray-200 mt-4 p-4 bg-white shadow-md shadow-blue-300 rounded-lg gap-2 h-48 overflow-auto">
                        ...
                        {!availability ? (
                          ...
                          <div className="flex col-span-2 w-full justify-center  items-center text-center">
                            <h1 className="bg-blue-200 p-4  rounded-lg font-semibold">
                          ...
                          <>
                            {Object.entries(availability).map(([hour]) => (
                              <button
                                ...
                                className=" border-blue-300 border-2 mt-2 rounded-lg focus:outline-none  focus:bg-blue-400 focus:text-white focus:font-semibold "
                              >
                                {hour}
                              </button>
                            ))}{" "}
                ...
                <div className="flex w-full justify-center">
                  <button
                    type="submit"
                    className="bg-button-primary  shadow-lg shadow-gray-500 text-black transition delay-150 duration-300 ease-in-out hover:bg-blue-400 font-semibold my-4 h-12 hover:scale-110   w-1/5 rounded   "
                  >
                    Reagendar cita
                  </button>
                </div>
