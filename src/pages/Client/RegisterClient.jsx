        ...
        <div className="flex flex-col sm:flex-row md:w-[85%]  mt-6  bg-gray-200 rounded-lg shadow-lg  shadow-gray-400   relative z-0">
          <div className="flex flex-col sm:flex  sm:absolute md:w-2/5 h-full z-10">
            <section className=" bg-blue-700  rounded-lg sm:rounded-none sm:bg-transparent flex flex-col w-full h-full justify-center items-center p-6">
              <img
                className="text-white rounded-md w-24 mb-8"
                src={img}
                alt="logo"
              />
              <h1 className="text-white h-8 text-2xl font-semibold mb-8">
                SOFTWASH
              </h1>
              <span className="text-white text-center ml-6 mr-6 text-1xl font-semibold">
                "Innovación que brilla en cada gota. Tu lavadero, nuestra
                tecnología."
              </span>
              <hr className=" shadow-xl shadow-white bg-white w-[70%]" />
              <button className="bg-button-primary shadow-lg transition delay-150 duration-300 ease-in-out shadow-blue-400 hover:scale-110 text-black font-semibold  lg:h-10 mt-4 rounded hover:bg-blue-400  md:h-16 w-2/3">
                <Link to="/register-user" className="py-4">
          ...
          <div className="w-full md:w-3/5 bg-gray-200 rounded-lg md:relative z-10">
            <section className="p-6">
              <h1 className="text-center font-semibold text-lg mt-2 mb-2">
                Lavadero
              </h1>
              <hr className=" bg-gray-300 shadow-xl shadow-white h-1 ml-6 mr-6 mb-2" />
              <form
                onSubmit={onSubmit}
                className="flex grid-cols-1 md:grid-cols-2  gap-4 max-w-md mx-auto"
              >
                <div className="grid grid-cols-4 gap-4">
                  <div className="col-span-2 relative">
                    <label className=" w-full font-semibold text-black px-4 py-2 rounded-md">
                      Numero de Rut <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      {...register("rutLaundry", { required: true })}
                      onChange={handleInputNit}
                      maxLength={10}
                      minLength={8}
                      className="w-10/12  text-black  border border-gray-300 px-4 py-2 rounded-md"
                      placeholder="RUT/NIT"
                    />
                    {errors.rutLaundry && (
                      <p className="absolute right-0 top-0  text-red-500">
                        &#9888;
                  ...
                  <div className="col-span-2 relative">
                    ...
                    <input
                      ...
                      className="w-10/12  text-black   border   px-4 py-2 rounded-md"
                  ...
                  <div className="col-span-2 relative">
                    ...
                    <input
                      ...
                      className="w-10/12   text-black px-4 py-2  border border-gray-300 rounded-md"
                      placeholder="Cra 4ta"
                    />
                    {errors.address && (
                      <p className="absolute right-0 top-0  text-red-500">
                  ...
                  <div className="col-span-2 relative">
                    ...
                    <input
                      ...
                      className="w-10/12  border border-gray-300 text-black px-4 py-2 rounded-md"
                  ...
                  <div className="col-span-2 ">
                    ...
                    <select
                      {...register("municipalityId", { required: true })}
                      className="font-Pathway Gothic One w-10/12 p-2 bg-white rounded-md border border-gray-300 focus:ring"
