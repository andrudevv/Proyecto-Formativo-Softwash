...
const styleActions =
  " flex justify-between items-center md:auto-cols-max sm:space-y-2";
...
export default function ViewProfileClient() {
  ...
  const handleModalUpdateService = handleSubmit(async (editService) => {
    ...
    const { id, name, duration, description, price, typeVehicles } =
      editService;
    const data = {
      name,
      duration,
  ...
  const customButtons = [
    {
      ...
      estilos:
        "bg-blue-500 hover:bg-blue-700 min-w-[70%] text-white font-bold h-auto py-1  px-2 rounded ",
    },
    {
      text: "Eliminar",
      tipo: "button",
      ...
      estilos:
        "bg-red-500 hover:bg-red-700 min-w-[70%] text-white font-bold py-1 px-2  rounded ",
    },
  ...
  const getServicesLaundry = async () => {
    try {
      ...
      toast.error("Error al obtener servicios del lavadero", {
        theme: "light",
      });
    }
  };
  ...
  return (
    <>
        ...
        {loading || !clientData ? (
          ...
          <>
            <DataProfileClient
              ...
              onClick={handleModalUpdateProfileOpen}
            />
          </>
        )}
      </div>
      <ModalUpdateProfileClient
        ...
        title={"Actualizar datos del lavadero"}
        message={"Modificacion de datos"}
        register={register}
        errors={errors}
        buttons={[
          {
            ...
            estilos:
              "bg-blue-500 hover:bg-blue-700 text-white font-bold h-auto py-1  px-2 rounded ",
          },
          {
            text: "Cancelar",
            tipo: "button",
      ...
      />
      <ModalUpdateService
        onSubmit={handleModalUpdateService}
        setValue={setValue}
        reset={reset}
        editingService={serviceSelected}
        handleSubmit={handleSubmit}
        isOpen={update}
      ...
      <div>
        ...
        <h1 className="flex justify-center text-2xl font-bold mt-8 mb-6">
          MIS SERVICIOS
        </h1>
        <ButtonAction
          estilos={
            "flex  bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 mb-4 w-auto justify-end"
          }
        ...
        <ContentTable
          ...
          stylesThead={stylesThead}
          stylesTbody={stylesTbody}
          styleActions={styleActions}
        />
        {/* </DivContent> */}
        <NavPagination
          styles={"flex justify-center"}
          styleOnMax={styleOnMax}
          page={page}
          setPage={setPage}
        />
        <ReusableModals
