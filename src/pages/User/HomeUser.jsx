                ...
                <div className="w-full h-full rounded-2xl flex items-center justify-center shadow-md shadow-gray-500 border-blue-100 border-2 bg-gray-100 duration-500">
                  <div className="grid grid-cols-1  text-center ">
                    <div className="flex justify-center ">
                      <img
                        src={callouts[currentIndex].imageSrc}
                        alt=""
                        className="h-[250px] w-[300px] rounded-xl"
                      />
                    </div>
                    <h2 className="flex justify-center">
                      {callouts[currentIndex].name}
                    </h2>
                    <button className="flex justify-center bg-blue-200 hover:bg-blue-400 rounded-md">
                      {callouts[currentIndex].description}
                    </button>
