          ...
          <div className="w-full mx-auto bg-white-100 bg-opacity-20 p-4 rounded-xl overflow-hidden shadow-md">
            <div className="md:flex flex-col">
              ...
              <div className=" grid grid-cols-2 gap-5 pl-8 pr-8 text-center">
                <h2 className="text-lg col-span-2 font-semibold text-center mt-8">
                  {dataServices ? dataServices.name : "nombre"}
                </h2>
                <p className="mt-2 ">
                  <strong>Nit:</strong>{" "}
                  {dataServices ? dataServices.rutLaundry : "Nit"}
                </p>
                <p className="mt-2">
                  <strong>Direccion:</strong>{" "}
                  {dataServices ? dataServices.address : "Direccion"}
                </p>
                <p className="mt-2">
                  <strong>Abierto:</strong>{" "}
                  {dataServices
                    ? dataServices.aperture
                    : " horario de apertura"}
                </p>
                <p>
                  <strong>Cerrado:</strong>{" "}
                  {dataServices ? dataServices.closing : "horario de cierre "}
                </p>
                <p>
                  <strong>Telefono:</strong>{" "}
                  {dataServices ? dataServices.phone : "telefono"}
                </p>
                <p>
                  <strong>Municipio:</strong>{" "}
                  {dataServices
                    ? dataServices.Municipality.name
                    : "nombre municipio"}
                </p>
              </div>
            </div>
