        ...
        <div className="flex flex-col sm:flex-row sm:w-[85%]  mt-6  bg-gray-200 rounded-lg shadow-lg  shadow-gray-400   relative z-0">
          <div className="flex flex-col   sm:absolute md:w-2/5 h-full z-10">
            <section className=" bg-blue-700  rounded-lg sm:rounded-none sm:bg-transparent flex flex-col w-full h-full justify-center items-center p-6">
              ...
              <button className="bg-button-primary shadow-lg shadow-blue-400 hover:scale-110 text-black font-semibold transition delay-150 duration-300 ease-in-out  mt-4 rounded hover:bg-blue-400  sm:h-16  w-2/3">
                <Link to="/register-client" className="py-6">
              ...
              >
                <div className="grid grid-cols-4 gap-4">
                  <div className="col-span-2 relative">
                    <label className="w-full mb-2  font-semibold text-black px-4 py-2 rounded-md">
                      Documento <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      {...register("documentUser", { required: true })}
                      maxLength={10}
                      minLength={8}
                      onChange={handleInputDoc}
                      className="w-10/12 mb-2 text-black px-4 py-2 rounded-md"
                      placeholder="Cedula"
                    />
                    {errors.documentUser && (
