                  ...
                  <div className="w-1/2 mx-20 py-4 px-8">
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <textarea
                        ...
                        className="block  text-gray-900  border-b-2 border-gray-400 w-full px-1 py-1   "
                    ...
                    <div className="relative w-full mb-5 group">
                      <label className=" text-gray-600 font-semibold">
                        Selecciona uno de tus Vehiculos{" "}
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <input
                        {...register("serviceId", { value: dateService.id })}
                        className="hidden"
                      />
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <input
                        {...register("amount", { value: dateService.price })}
                        className="hidden"
                      />
                      <label className="block  text-gray-900  border-b-2 border-gray-400 break-all ">
                        {dateService.price}
