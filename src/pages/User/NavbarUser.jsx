    ...
    <header className="flex bg-gradient-to-r from-blue-900 via-blue-700 to-blue-700 p-2  justify-between items-center fixed w-full top-0 z-10">
      ...
      <div className="flex items-center mt-2 md:mt-0 md:ml-6">
        <div className="hidden md:flex space-x-4">
          ...
          <button className="text-white  hover:text-cyan-400" onClick={openModalOpen}><Link to="/" className="font-Pathway Gothic One font-bold mr-4">Cerrar Sesión</Link></button>
        </div>
            ...
            <div className="absolute right-0 top-16 mt-4  p-2 w-full text-end  bg-blue-700">
              <ul className="bg-blue-700 p-4 text-xl shadow-md shadow-black">
                <li className="cursor-pointer mb-4 text-center font-bold text-2xl">
                  <span className="hover:text-SoftRed font-Pathway text-white Gothic One">Hola {user.name}</span>
                </li>
                <li className='my-2'>
                  ...
                  <li className='my-2'>
                    <button className="font-Pathway Gothic One">
                      <Link to="/search" className="font-Pathway Gothic One hover:text-cyan-400 text-white font-bold">Buscar Lavaderos</Link>
                    </button>

                  </li>
                  <li className='my-2'>
                    <button className="font-Pathway Gothic One">
                      <Link to="/my-appointments" className="font-Pathway Gothic One hover:text-cyan-400 text-white font-bold ">Citas</Link>
                    </button>

                  </li>
                  <li className='my-2'>
                    <button className=" font-Pathway Gothic One">
                      <Link to="/view-profile-user" className="font-Pathway Gothic One hover:text-cyan-400 text-white font-bold ">My Perfil</Link>
                    </button>

                  </li>
                <li className="cursor-pointer">
                  <button className=" font-Pathway Gothic One" onClick={openModalOpen}><Link to="/" className="font-Pathway Gothic One text-white hover:text-cyan-400 font-bold">Cerrar Sesión</Link></button>
                </li>
