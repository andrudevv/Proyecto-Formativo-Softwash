...
export default function GenericNavbar() {
    ...
    return (
        <header className="bg-gradient-to-r from-blue-900 via-blue-700 to-blue-700 p-4 flex justify-between items-center fixed w-full top-0 z-10">
            ...
            <div className="flex items-center mt-2 md:mt-0 md:ml-6">
                ...
                <div className="hidden md:flex space-x-4">
                    <button className="text-white hover:text-cyan-400"><Link to="/sign-in-user">Iniciar Sesión</Link></button>
                    <button className="text-white hover:text-cyan-400"><Link to="/register-user">Registrarse</Link></button>
                </div>
