              ...
              <div className="modal-content text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      type="text"
                      {...register("typeVehicles", { required: true })}
                      className="mt-1 p-2 border border-gray-300 rounded-md"
                      placeholder="carro"
                    />
                    {errors.typeVehicles && (
          ...
          <div className="modal-actions bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            {buttons.map((button, index) => (
              <button
                ...
                className={`${
                  index > 0 ? "ml-3" : ""
                } w-full inline-flex justify-center rounded-md border border-gray-300 shadow-md px-4 py-2 bg-white font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-200 sm:w-auto sm:text-sm ${
                  button.styles
                }`}
              >
                {button.text}
