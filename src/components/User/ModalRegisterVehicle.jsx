          ...
          <div className="modal-wrapper bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="modal-wrapper-flex sm:flex flex justify-center sm:items-start">
              <div className="modal-content text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="modal-text my-2"></div>
                <form onSubmit={onSubmit}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      className="mt-1 p-2 uppercase border border-gray-300 rounded-md"
                      placeholder="ABC-123 / ABC-12A"
                    />
                    {errors.plate && (
                      <p className=" right-0 top-0  text-red-500">
                        &#9888;requerido
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      className="mt-1 lowercase p-2 border border-gray-300 rounded-md"
                      placeholder="carro"
                    />
                    {errors.typeVehicle && (
                      <p className="absolute right-0 top-0  text-red-500">
