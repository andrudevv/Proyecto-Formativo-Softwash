...
import img from '../components/imginterfaz/Element_Genshin_Hydro.jpg';
    ...
    <header className="bg-blue-500 p-4 flex justify-between items-center fixed w-full top-0 z-10">
      ...
      <div className="flex items-center mt-2 md:mt-0 md:ml-6">
        <div className="hidden md:flex space-x-4">
          <button className="text-white"><a href="/iniciarsession">Iniciar Sesión</a></button>
        ...
        <div className="md:hidden ml-auto">
          ...
          {menuOpen && (
            <div className="absolute mt-2 w-full bg-blue-500 p-4 right-0">
