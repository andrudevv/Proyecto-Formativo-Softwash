  ...
  return (
    <div id="modal-component-container" className="fixed z-10 inset-0">
      <div className="modal-flex-container flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="  inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle max-w-3xl sm: w-full">
          <div className="modal-wrapper bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="modal-wrapper-flex sm:flex flex grid-cols-1 gap-4  sm:items-start">
              <div className="modal-content text-center mt-3  sm:mt-0 w-full sm:ml-4 sm:text-left">
                <h3 className="text-lg font-medium text-center my-4 text-gray-900">
                  {title}
                </h3>
                ...
                >
                  ...
                  <div className="col-span-2 flex flex-col relative">
                    ...
                    <input
                      ...
                      className="mt-1 p-2 border border-gray-300 rounded-md"
                      placeholder="cra 7ma norte frente"
                    />
                    {errors.address && (
                      <p className="absolute right-0 top-0  text-red-500">
                        &#9888;requerido
                  ...
                  <div className="col-span-2 flex flex-col relative">
                    ...
                    <input
                      type="text"
                      {...register("aperture", { required: true })}
                      className="mt-1 p-2 border border-gray-300 rounded-md"
          ...
          <div className="modal-actions bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            {buttons.map((button, index) => (
              <button
                ...
                className={`${
                  index > 0 ? "ml-3" : ""
                } w-full inline-flex justify-center rounded-md border border-gray-300 shadow-md px-4 py-2  font-medium text-gray-700  focus:outline-none focus:ring-2 focus:ring-offset-2 sm:w-auto sm:text-sm ${
                  button.estilos
                }`}
              >
                {button.text}
