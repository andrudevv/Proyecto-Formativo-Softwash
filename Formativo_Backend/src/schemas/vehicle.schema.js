...
const getVehicleSchema = Joi.object({
  id: id.required().messages({
    ...
    "any.required":
      "El ID de vehiculo es un campo obligatorio. y debe ser un numero entero",
...
const createVehicleShema = Joi.object({
  plate: plate
    .required()
    .messages({
      "string.min": "La longitud mínima de (placa) es de 5 caracteres.",
      "string.max":
        "La longitud máxima de (placa) es de 6 caracteres. y un guion (-)",
      "string.pattern.base":
        "El campo (placa) no cumple con el formato de placa válido verifica que este en mayusculas y contenga el guion(-).",
      "string.base": 'El campo "placa" debe ser una cadena de texto.',
  ...
  model: model.required().messages({
    ...
    "number.min":
      "El modelo debe ser un número entero minimo de 4 dígitos a partir del año 1900",
    "number.max":
      "El modelo debe ser un número entero maximo de 4 dígitos hasta el año2024.",
  }),
...
const updateParams = Joi.object({
  id: id.required().messages({
    ...
    "any.required":
      "El numero de vehiculo es un campo obligatorio. y debe ser un numero entero",
