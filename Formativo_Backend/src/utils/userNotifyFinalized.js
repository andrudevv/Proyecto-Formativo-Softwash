...
function userNotifyFinalized(email, plate) {
  return new Promise((resolve, reject) => { 
  // Envía un correo con el token
  const mailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: "Servicios finalizados",
    html: `
    <html>
    <head>
      <style>
    ...
    <div class="bod"> 
      ...
      <h1 class="title">Cita finalizada</h1> 
      <p class="parrafo-body">
      Cita finalizada exitosamente, Ya puedes regresar por el vehículo  con placa:${plate}.
      ¡Gracias por usar de nuestros servicios. Esperamos que regrese pronto!.
...
module.exports = {userNotifyFinalized};